import { GetManoDeObraUseCase } from "@/core/application/use-cases/estadisticas/get-mano-de-obra.case";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await new GetManoDeObraUseCase(
      new EstadisticasManoDeObraService()
    ).execute(dto);
