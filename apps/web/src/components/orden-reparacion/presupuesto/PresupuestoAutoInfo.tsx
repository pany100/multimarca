...
function PresupuestoAutoInfo({ presupuesto }: { presupuesto: any }) {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={4}>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={8} sm={9}>
              <Typography variant="body2">{presupuesto.auto.brand}</Typography>
            </Grid>
            ...
            <Grid item xs={8} sm={9}>
              <Typography variant="body2">{presupuesto.auto.model}</Typography>
            </Grid>
            ...
            <Grid item xs={8} sm={9}>
              <Typography variant="body2">{presupuesto.auto.patent}</Typography>
            </Grid>
...
export default PresupuestoAutoInfo;
