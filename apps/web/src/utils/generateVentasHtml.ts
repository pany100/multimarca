...
export default function generateClientOrderHtml(venta: any, encabezadoPdf?: string): string {
  ...
  return `
    ...
    <body>
      <div class="PDFPage">
        <div class="PDFHeader">
          <svg width="170px" height="170px" viewBox="0 0 96 96" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        '>
          ...
          <div style='
            ...
            margin-right: 15px;
          '>
          ${generateAjustesRowsHtml(venta, calculoVO)}
