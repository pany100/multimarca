import { AddMecanicoToOrdenUseCase } from "@/core/application/use-cases/orden-reparacion/add-mecanico-to-orden.use-case";
import { PrismaOrdenReparacionRepository } from "@/core/infrastructure/database/repositories/prisma-orden-reparacion.repository";
import { addMecanicoToOrdenSchema } from "@/core/infrastructure/validation/schemas/orden-reparacion.schema";
