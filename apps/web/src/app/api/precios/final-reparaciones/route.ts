...
import { GetPreciosFinalReparacionesUseCase } from "@/core/application/use-cases/precios/get-precios-final-reparaciones.use-case";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await new GetPreciosFinalReparacionesUseCase(
      new GetPreciosFinalReparacionesService()
    ).execute(dto);
