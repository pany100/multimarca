...
const EditarIngresoManualPage = ({ params }: Params) => {
    ...
    (async () => {
      try {
        ...
        setInitialValues({
          ...
          cotizacionDolar:
            body.cotizacionDolar != null ? Number(body.cotizacionDolar) : undefined,
          usuarioId: body.usuarioId,
          descripcion: body.descripcion ?? "",
          tipoOperacionId: body.tipoOperacionId,
          chequeId: body.chequeId ?? null,
          gastosBancarios: body.gastosBancarios != null ? Number(body.gastosBancarios) : 0,
    ...
    <Box sx={{ p: { xs: 2, md: 3 } }}>
      ...
      <Card>
        <CardHeader
          ...
          subheader={`Modificá los datos del ingreso #${id}`}
...
export default EditarIngresoManualPage;
